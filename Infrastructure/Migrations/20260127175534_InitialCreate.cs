        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Insurances_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsuranceSuggestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InsuranceSuggestions_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Insurances_AssetId",
                table: "Insurances",
                column: "AssetId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InsuranceSuggestions_AssetId",
                table: "InsuranceSuggestions",
                column: "AssetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpaceUsers_SpaceId_UserId",
                table: "SpaceUsers",
